...
export function NewTask () {
    return (
        <div className="flex flex-1 items-center justify-center gap-2 transform -translate-y-1/2">
            ...
            <button type="submit"
             className="p-2.5 flex justify-center items-center gap-2 rounded-lg bg-[#1E6F9F] w-90 hover:bg-[#4EA8DE] text-[#F2F2F2] font-inter text-base">Criar <PlusCircle size={20}
            /></button>
        </div>
    )
}